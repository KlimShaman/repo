...
try:
    ...
    option = st.selectbox(
        ...
        ('Посчитать актуарную современную стоимость временной пожизненной ренты', 'Посчитать актуарную современную стоимость полной пожизненной ренты', 'Посчитать актуарную современную стоимость обязательств перестраховочной компании')
    )
