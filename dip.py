...
try:
    ...
    option = st.selectbox(
        ...
        ('Посчитать актуарную современную стоимость временной пожизненной ренты', 
         ...
         'Посчитать временную будущую пенсию',
         'Посчитать пожизненную будущую пенсию')
    )
    if (option == 'Посчитать актуарную современную стоимость временной пожизненной ренты'):
        ...
        ('Мужской', 'Женский'))
         if (pol == 'Мужской'):
            st.write('Пенсия (руб/мес) =', A5(age, 65, per, pl))
         else:
            st.write('Пенсия (руб/мес) =', A5(age, 60, per, pl))
