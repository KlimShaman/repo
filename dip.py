...
option = st.selectbox(
    ...
    ('Посчитать современную стоимость полной пожизненной ренты, выплачиваемой раз в год', 'Home phone', 'Mobile phone')
)
if (option == 'Посчитать современную стоимость полной пожизненной ренты, выплачиваемой раз в год'):
